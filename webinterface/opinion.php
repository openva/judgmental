...
echo '<div class="name"><h1>' . $opinion->name . ' <span class="number">(Case No. ' . $opinion->number . ')</span></h1></div>';
echo '<div class="date">' . date('F j, Y', strtotime($opinion->date_published)) . '</div>';
echo '<div class="location">' . $opinion->court . '</div>';
