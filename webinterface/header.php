...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="js/vendor/jquery-ui-1.8.13.custom.min.js"></script>
        <script src="js/vendor/jquery.metadata.js"></script>
        <script src="js/vendor/jquery.tablesorter.min.js"></script>
        <script src="js/plugins.js"></script>
        <script src="js/vendor/ui.dropdownchecklist.js"></script>
        ...
        <script>(function(d, s, id) {
          ...
          js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=495928953775088";
